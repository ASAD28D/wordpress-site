<?php
add_action("wp_enqueue_scripts", "enqueue_wp_custom_css");

function enqueue_wp_custom_css()
{
    wp_enqueue_style("custom-css", get_stylesheet_directory_uri() . "/assets/css/theme_custom.css");
}
